      ...
      if (this.checkedList.length > 0) {
        ...
        navigationWarning(obj).then(response => {
          if (response && response.data && response.data.datas) {
            ...
            if (response.data.datas.pirate.length === 0 && response.data.datas.navigationWarning.length === 0) {
              this.$alert(i18n.t('shipHall.noData'), '', {
        ...
        this.$alert(i18n.t('piratesDrills.noSelect'), '', {
          confirmButtonText: i18n.t('history.confirm')
        })
      }
    }
